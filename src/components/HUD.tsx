...
export default function HUD({ satoshis, fishCount, totalMined, onShopToggle }: Props) {
  ...
  return (
    <div className="glass-panel" style={{
      ...
      <div style={{ display: "flex", gap: 12, fontSize: 12, color: "#8ecdf7", marginBottom: 10 }}>
        <span>🐠 {fishCount} fish</span>
        <span>⛏ {Math.floor(totalMined)} mined</span>
      </div>

      <button
        onClick={(e) => { e.stopPropagation(); onShopToggle(); }}
        style={{
      ...
      <div style={{ fontSize: 10, color: "#8ecdf766", marginTop: 8, textAlign: "center" }}>
