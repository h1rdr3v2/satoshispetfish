...
const SHOP_ITEMS: ShopFish[] = [
  ...
  },
  {
    ...
    emoji: "🐠",
    overrides: { size: 45, mineRate: 1.0, color: "#ff6b35", species: "Clownfish" },
  },
  {
    name: "Angelfish",
    cost: 300,
    ...
    emoji: "🐡",
    overrides: { size: 52, mineRate: 1.5, color: "#d500f9", species: "Angelfish" },
  },
  {
    name: "Neon Tetra",
    cost: 100,
    ...
    emoji: "✨",
    overrides: { size: 30, mineRate: 0.8, color: "#00e5ff", species: "Neon Tetra" },
  },
  {
    name: "Golden Koi",
    cost: 500,
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        💡 Tip: Click fast for combo bonuses!<br />
